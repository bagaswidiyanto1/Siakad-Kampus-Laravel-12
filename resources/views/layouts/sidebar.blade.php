                ...
                <div x-show="adminOpen && sidebarOpen" x-transition x-cloak class="mt-1 space-y-1 pl-8">
                    ...
                    @can('permission.manage')
                        <a href="{{ route('admin.activity-logs.index') }}"
                            class="block px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 hover:text-blue-600 rounded-lg {{ request()->routeIs('admin.activity-logs.*') ? 'bg-blue-50 text-blue-600' : '' }}">
